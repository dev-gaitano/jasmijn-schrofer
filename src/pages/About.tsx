...
const AboutPage = () => {
  ...
  const renderLogos = (isMobile: boolean = false, suffix: string = "") => {
    const sizeClasses = {
      logo1: isMobile ? "w-auto h-12" : "w-auto h-16",
      logo2: isMobile ? "w-auto h-10" : "w-auto h-12",
      logo3: isMobile ? "w-12 max-h-12" : "w-16 max-h-16",
      logo4: isMobile ? "w-auto h-12" : "w-auto h-16",
    ...
    return (
      <>
        ...
        <svg
          className={sizeClasses.logo4}
          width="200"
          height="180"
          viewBox="280 240 500 450"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
            d="M302,262 L461,262 L461,359 L397,359 L397,549 L461,549 L461,666 L302,666 Z"
            fill="currentColor"
            stroke="currentColor"
            stroke-width="1"
          />
          <path
            d="M760,262 L601,262 L601,359 L665,359 L665,549 L601,549 L601,666 L760,666 Z"
            fill="currentColor"
            stroke="currentColor"
            stroke-width="1"
          />
        ...
        <img
          className={sizeClasses.logo5}
          src="https://res.cloudinary.com/diwkfbsgv/image/upload/v1784220537/manchester-city-football_oytwcp.png"
        />
        <svg
          className={sizeClasses.logo6}
          xmlns="http://www.w3.org/2000/svg"
          version="1.0"
          width="577.89929"
          height="126.01392"
          viewBox="0 0 577.89929 126.01392"
        >
          <g transform="translate(654.664, -35.0695)">
            <g transform="translate(-7.88281e-06, 1.11987e-06)">
              <path
                d="M -232.65303,47.220843 L -177.05553,47.220843 L -177.05553,35.693344 L -232.65303,47.220843"
                style={{
                  opacity: 1,
                  fill: "currentColor",
                  fillRule: "nonzero",
        ...
        <section id="about" className="relative p-gap-md md:p-gap-xxl w-full">
          ...
          <div className="relative z-10 space-y-gap-lg">
            <div className="mt-gap-xl md:mt-0 md:gap-gap-xxl flex flex-col items-start">
              <div className="grid grid-cols-1 md:grid-cols-2 md:gap-gap-xxl items-start">
                ...
                <div className="xxs:mt-8 xxs:mb-8 md:mt-0 md:mb-0">
                  ...
                  >
                    ...
                    <p className="italic text-sm md:text-lg text-foreground-muted leading-relaxed">
              ...
              {/* Desktop view (static grid/flex row) */}
              <div className="hidden md:flex w-full justify-between items-center gap-gap-lg">
                {renderLogos(false, "desktop")}
              </div>

              {/* Mobile view (self-rotating carousel) */}
              <div className="w-full overflow-hidden md:hidden py-gap-md my-gap-md">
                <div className="flex animate-smooth-scroll w-max gap-0">
                  <div className="flex gap-12 items-center pr-12">
                    {renderLogos(true, "mobile-1")}
                  </div>
                  <div className="flex gap-12 items-center pr-12">
                    {renderLogos(true, "mobile-2")}
                  </div>
                </div>
              </div>
