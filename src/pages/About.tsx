...
const AboutPage = () => {
  ...
  const renderLogos = (isMobile: boolean = false, suffix: string = "") => {
    const sizeClasses = {
      ...
      logo4: isMobile ? "h-12" : "h-16",
      logo5: isMobile ? "h-12" : "h-16",
      logo6: isMobile ? "h-12" : "h-16",
    ...
    return (
      <>
        ...
        <img
          ...
          src="https://res.cloudinary.com/diwkfbsgv/image/upload/v1784222299/copy_of_copy_of_african-slum-journal-monochrome_xmnczj.png"
        />
        <img
